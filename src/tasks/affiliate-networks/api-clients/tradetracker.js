...
const TradeTrackerSoapClientPool = {
  ...
  getClient: co.wrap(function* (s_region) {
    ...
    if (!API_CREDENTIALS[s_region]) throw new Error("Unknown TradeTracker region: " + s_region);
    ...
    const client = new TradeTrackerSoapClient(s_region);
 ...
 */
function TradeTrackerSoapClient(s_region) {
  if (!(this instanceof TradeTrackerSoapClient)) return new TradeTrackerSoapClient(s_region);
