(function() {
  ...
  var expect = require('chai').expect;
	...
	var adCellApi = require(process.cwd() + '/src/tasks/affiliate-networks/adCellGenericApi')();
	var adCellApiClient = require(process.cwd() + '/src/tasks/affiliate-networks/api-clients/adCell')('ominto');
